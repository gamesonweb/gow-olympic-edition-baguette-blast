...
class PigeonBossController extends EnemyController {
    protected _model: PigeonBossModel;
    protected _view: PigeonBossView;

    /////////////////
    // Constructor //
    /////////////////

    public constructor(model: PigeonBossModel, view: PigeonBossView) {
        super(model, view);
    }
